...
| `verify-reading-performance.mjs` | 大型 EPUB/PDF 统一 Source 性能验收:真实 Chrome 覆盖 EPUB 首屏/章节切换/资源加载与 PDF 文档信息/首屏/翻页/窗口化滚动位置恢复,记录首次可见内容耗时、阶段累计范围字节、最大范围和读取峰值。 | `pnpm test:reading-performance` |
